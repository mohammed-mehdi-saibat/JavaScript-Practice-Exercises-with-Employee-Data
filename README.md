...
Find projects with only one employee assigned
...
Find the most popular project (most employees)
...
Create a new array with full names (firstName + lastName)
...
Create an object grouping employees by first letter of last name
...
Build a dictionary of projects with assigned employee names
...
Create a nested structure: departments → projects → employees
...
Reverse all employee names (firstName and lastName separately)
...
Replace all vowels in names with '\*'
...
Create a string of all employee emails separated by ';'
...
Calculate the average number of skills by department
...
Find the most common language combination
...
Calculate the average project participation by age group
...
Determine the most frequent first name initial
...
Find the average salary difference between active/inactive employees
...
Calculate the retention rate by join year
...
Find employees whose skills include both "JavaScript" and "React"
...
List employees with special characters in their last names
...
Find employees whose email domain is not "company.com"
...
Group employees by number of projects (0, 1-2, 3+)
...
Find employees with anagrams in their names (e.g., "Jean" and "Jane")
...
List employees whose full name contains all vowels
...
Find employees with the same first name but different last names
...
Group employees by the length of their first name
...
Find employees whose last name is a palindrome
...
Create a search function that finds employees by any property value
